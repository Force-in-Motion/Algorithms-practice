...
from recursive_max.main import *
from recursive_max.config import *
...
class MainFrame(ctk.CTkFrame):
    ...
    def button_click(self):
        ...
        sum_elems = recursive_max(lst_nums)

        self.__result_output_field.configure(text=f'Максимальный элемент массива: {sum_elems}')
